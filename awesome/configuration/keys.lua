...
awful.keyboard.append_global_keybindings({
        ...
        awful.key({modkey}, "t", function()
            awful.spawn.with_shell(tauon_music)
        end,
        {description = "open music box", group = "launcher"}),
        awful.key({modkey}, "o", function()
            awful.spawn.with_shell(obsidian)
        end,
        {description = "open obsidian md", group = "launcher"}),
        awful.key({modkey}, "b", function()
            awful.spawn.with_shell(brave)
        end,
        {description = "open brave browser", group = "launcher"}),
        awful.key({modkey}, "e", function()
            awful.spawn.with_shell(email)
        end,
        {description = "open email client", group = "launcher"}),
        awful.key({modkey}, "i", function()
            awful.spawn.with_shell(todoist)
        end,
        {description = "open todoist", group = "launcher"}),
        awful.key({modkey}, "w", function()
            awful.spawn.with_shell(whatsapp)
        end,
...
awful.keyboard.append_global_keybindings({
    ...
    awful.key({}, "Print", function()
        awful.spawn.with_shell("scrot /home/mangel/Pictures/Screenshots/$.jpg")
    end,
    {description = "take a full screenshot", group = "hotkeys"}),

    awful.key({alt}, "Print", function()
        awful.spawn.with_shell("scrot -s /home/mangel/Pictures/Screenshots/$.jpg")
    end,
